...
var MaterializeDirective = (function () {
    ...
    MaterializeDirective.prototype.performElementUpdates = function () {
        ...
        if (this.isAutocomplete()) {
            ...
            jQueryElement.on("change", function (e) { return nativeElement_2.dispatchEvent(new custom_event_polyfill_1.CustomEvent("input")); });
        }
        if (this.isDatePicker()) {
            ...
            jQueryElement_1.on("change", function (e) { return nativeElement_3.dispatchEvent(new custom_event_polyfill_1.CustomEvent("input")); });
    ...
    MaterializeDirective.prototype.performLocalElementUpdates = function (functionName) {
        var _this = this;
        ...
        $(document).ready(function () {
            ...
            if (functionName) {
                ...
                if (jQueryElement[functionName]) {
                    if (_this._params) {
                        if (_this._params instanceof Array) {
                            jQueryElement[functionName].apply(jQueryElement, _this._params);
                        }
                        else {
                    ...
                    if (Materialize[functionName]) {
                        if (_this._params) {
                            if (_this._params instanceof Array) {
                                Materialize[functionName].apply(Materialize, _this._params);
                            }
                            else {
                                throw new Error("Params has to be an array.");
                            }
